[undercover.html](https://github.com/user-attachments/files/23809308/undercover.html)
<!DOCTYPE html>
<html>
<head>
...
<!-- 🔥 Firebase COMPAT Versions (must be compat for this code to work) -->
...
<script>
  ...
  // ⛔ MUST use compat version for this game to work
  ...
  db.ref("rooms").on("value", snap => {
    ...
    if (room && room.phase === "describe") {
      ...
      db.ref("rooms/" + currentRoom + "/words/" + myUID)
        .once("value")
        .then(wordSnap => {
          document.getElementById("yourWord").innerText = wordSnap.val() || "❓ YOU are the Undercover!";
        });
    }
  });
